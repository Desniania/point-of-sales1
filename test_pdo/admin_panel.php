...
<body>
        ...
        <div class="container mx-auto flex justify-between items-center p-5">
            ...
            <nav>
                <ul class="flex space-x-4">
                    ...
                    <li><a href="../index.php" class="hover:underline">Menu</a></li>
                    <li><a href="../index.php" class="hover:underline">About</a></li>
                    <li><a href="../index.php" class="hover:underline">Contact</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <div class="container mt-4">
        <a href="tambah.php" class="btn btn-custom mb-3">+ TAMBAH DATA</a>
            ...
            <table class="table table-striped table-bordered colored-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($isi['password']); ?></td>
